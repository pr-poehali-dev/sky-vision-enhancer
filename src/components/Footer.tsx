export function Footer() {
  const footerLinks = {
    "Продукты": ["Маркет лидов", "Перехват аудитории", "Предварительный звонок", "Мобильный кабинет", "Аналитика", "API"],
    "Агентствам": ["Тарифы", "Верификация", "Пополнение баланса", "Условия работы", "FAQ", "Кейсы партнёров"],
    "Компания": ["О платформе", "Команда", "Пресс-кит", "Новости", "Вакансии", "Блог"],
    "Поддержка": ["Документация", "Статус системы", "Конфиденциальность", "Оферта", "Обработка данных"],
    "Связаться": ["Контакты", "Telegram", "WhatsApp", "Email поддержки"],
  }
