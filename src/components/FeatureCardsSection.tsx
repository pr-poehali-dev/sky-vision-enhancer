...
const featureCards = [
  ...
  {
    title: "Личный кабинет агентства",
    illustration: (
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <img
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              Всё для роста продаж недвижимости
            </motion.h2>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                LeadEstate построен на реальных данных о покупателях недвижимости:
                горячие лиды, перехват аудитории застройщиков и умный кабинет для работы с клиентами.{" "}
                <a href="#" className="text-white inline-flex items-center gap-1 hover:underline">
                  Смотреть маркет <ChevronRight className="w-4 h-4" />
                </a>
              </p>
            </motion.div>
          </div>
