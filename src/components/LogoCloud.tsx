...
const companies = [
  { name: "Этажи", icon: Zap },
  { name: "Инком", icon: Hexagon },
  { name: "Миэль", icon: Diamond },
  { name: "НДВ", icon: Star },
  { name: "Самолёт", icon: Sparkles },
  { name: "А101", icon: Globe },
  { name: "ПИК", icon: Circle },
  { name: "Est-a-Tet", icon: Square },
]
    ...
    <div className="relative z-20 pb-24 pt-8" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            Нам доверяют ведущие агентства и брокеры России.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            От региональных агентств до федеральных сетей.
          </motion.p>
