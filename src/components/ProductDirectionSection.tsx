    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Воронка продаж и работа с лидами</span>
        ...
        >
          Ведите каждого лида до сделки
        </h2>

        {/* Description */}
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Назначайте менеджеров и отслеживайте статус.</span> Весь путь клиента — от первого контакта до подписания договора — в одном кабинете.
        </p>
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              >
                ...
                <span className="text-zinc-300 text-sm font-medium">Новый лид → Менеджер назначен</span>
                <div
              ...
              >
                ...
                <span className="text-zinc-500 text-sm">Звонок состоялся</span>
              </div>
              ...
              >
                <span className="text-zinc-400 text-sm">Показ объекта</span>
              ...
              >
                <span className="text-zinc-400 text-sm">Сделка закрыта</span>
                <div className="flex gap-0.5">
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Карточка лида с историей</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Все взаимодействия, заметки, звонки и статусы по каждому клиенту в одном месте.
            </p>

            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-200 mb-5">Лид L-2841 · Алексей М.</h4>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-300 text-xs">
                    <span className="text-indigo-400">Москва, НМ</span>
                  </span>
              ...
              <div className="flex items-start gap-4">
                <span className="text-zinc-500 text-sm w-20 pt-1">Воронка</span>
                <div className="flex flex-col gap-2">
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-indigo-500" />
                    Лид куплен <span className="text-zinc-500">сегодня 10:42</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-indigo-500" />
                    Звонок состоялся <span className="text-zinc-500">13:15</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-400 text-sm">
                    ...
                    Показ объекта <span className="text-zinc-500">запланирован</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-b border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Статус в реальном времени</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Каждый лид имеет статус — вы всегда знаете, на каком этапе находится каждый клиент.
            </p>
            ...
            <div className="relative h-48">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-green-500 font-medium text-sm">Сделка закрыта</span>
                </div>
                <p className="text-zinc-300 text-sm mb-3">Клиент подписал договор на 2-комн. в ЖК «Дом»</p>
                <span className="text-zinc-500 text-xs">Сегодня, 15:30</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="border-r border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-200 font-medium">Назначение менеджера на лид</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-indigo-500/50" />
                <span className="text-zinc-400">Заметки и комментарии к клиенту</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-indigo-500/30" />
                <span className="text-zinc-500">Отслеживание конверсий в сделку</span>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <div className="mb-3 relative inline-block">
                  <span className="text-zinc-200 text-lg font-medium">Алексей М., 34 года —</span>
                  <span className="relative mx-1">
                    <span className="text-zinc-200 text-lg font-medium bg-indigo-500/20 px-0.5">в работе</span>
                    <span className="absolute -top-4 right-0 px-1.5 py-0.5 rounded text-[10px] bg-indigo-600 text-white">
                      Иван
                    </span>
                  </span>
                </div>
                ...
                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                  ...
                  <span className="relative inline">
                    <span className="bg-purple-500/20 px-0.5">2-комн</span>
                    <span className="absolute -bottom-4 left-0 px-1.5 py-0.5 rounded text-[10px] bg-purple-600 text-white">
                      Анна
                    </span>
                  </span>
                  . квартиру в ЖК ПИК или Самолёт. Бюджет до 9,5 млн ₽, ипотека одобрена в Сбербанке.
                </p>
